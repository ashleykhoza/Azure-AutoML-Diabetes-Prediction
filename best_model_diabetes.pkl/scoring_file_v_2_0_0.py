...
data_sample = PandasParameterType(pd.DataFrame({"PatientID": pd.Series([0], dtype="int64"), "Pregnancies": pd.Series([0], dtype="int64"), "PlasmaGlucose": pd.Series([0], dtype="int64"), "DiastolicBloodPressure": pd.Series([0], dtype="int64"), "TricepsThickness": pd.Series([0], dtype="int64"), "SerumInsulin": pd.Series([0], dtype="int64"), "BMI": pd.Series([0.0], dtype="float64"), "DiabetesPedigree": pd.Series([0.0], dtype="float64"), "Age": pd.Series([0], dtype="int64")}))
